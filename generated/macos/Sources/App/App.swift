...
private final class OwlSession: ObservableObject {
  ...
  private func optimisticMessage(for thread: ThreadItem, transport: Transport, subject: String, body: String) -> MessageItem {
  ...
  func sendComposedMessage() {
    ...
    let root = mailRoot
    let optimistic = optimisticMessage(for: thread, transport: transport, subject: subject, body: body)
