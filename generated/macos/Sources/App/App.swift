...
private let menuBarIR = #"{"id":"menubar.main","type":"MenuBar","children":[{"id":"menu.app","type":"Menu","title":"Owl Native","children":[{"id":"menuitem.openSettings","type":"MenuItem","title":"Settings","action":"open_settings"},{"id":"menuitem.quit","type":"MenuItem","title":"Quit","action":"quit_app"}]},{"id":"menu.file","type":"Menu","title":"File","children":[{"id":"menuitem.save","type":"MenuItem","title":"Save","action":"save_document","shortcut":"cmd+s"}]}]}"#
...
private let contentIR = #"{"id":"content.main","type":"Content","child":{"id":"stack.root","type":"Stack","axis":"vertical","spacing":16,"children":[{"id":"section.hero","type":"Section","title":"Overview","child":{"id":"stack.hero","type":"Stack","axis":"vertical","spacing":12,"children":[{"id":"text.headline","type":"Text","style":"title","value":"Owl Native"},{"id":"text.summary","type":"Text","style":"body","value":"Native desktop app scaffolded by App Forge."},{"id":"group.form","type":"Group","title":"Quick action","child":{"id":"form.settings","type":"Form","children":[{"id":"input.projectName","type":"Input","label":"Project name","stateKey":"project_name","placeholder":"Owl Native"},{"id":"button.primary","type":"Button","title":"Save draft","action":"save_document"}]}}]}}]}}"#
